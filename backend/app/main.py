...
def startup_event():
    ...
    try:
        ...
        try:
            ...
            db.execute(text("ALTER TABLE opportunities ADD COLUMN IF NOT EXISTS link_classification VARCHAR;"))
            db.execute(text("ALTER TABLE opportunities ADD COLUMN IF NOT EXISTS link_quality_score INTEGER DEFAULT 25;"))
            db.execute(text("ALTER TABLE opportunities ADD COLUMN IF NOT EXISTS verified_apply_url VARCHAR;"))
            db.execute(text("ALTER TABLE opportunities ADD COLUMN IF NOT EXISTS source_job_id VARCHAR;"))
            db.execute(text("ALTER TABLE opportunities ADD COLUMN IF NOT EXISTS last_url_verified_at TIMESTAMP;"))
            db.execute(text("ALTER TABLE opportunities ADD COLUMN IF NOT EXISTS apply_attempts INTEGER DEFAULT 0;"))
            db.execute(text("ALTER TABLE opportunities ADD COLUMN IF NOT EXISTS apply_success INTEGER DEFAULT 0;"))
            db.execute(text("ALTER TABLE opportunities ADD COLUMN IF NOT EXISTS apply_failure INTEGER DEFAULT 0;"))
            db.execute(text("ALTER TABLE opportunities ADD COLUMN IF NOT EXISTS homepage_redirects INTEGER DEFAULT 0;"))
            db.execute(text("ALTER TABLE opportunities ADD COLUMN IF NOT EXISTS published_at TIMESTAMP;"))
            db.execute(text("ALTER TABLE opportunities ADD COLUMN IF NOT EXISTS expires_at TIMESTAMP;"))
            db.execute(text("ALTER TABLE opportunities ADD COLUMN IF NOT EXISTS source_type VARCHAR DEFAULT 'DIRECT_EMPLOYER';"))
            db.execute(text("ALTER TABLE opportunities ADD COLUMN IF NOT EXISTS is_active BOOLEAN DEFAULT TRUE;"))
            ...
            db.execute(text("CREATE INDEX IF NOT EXISTS ix_opportunities_link_quality_score ON opportunities (link_quality_score);"))
            db.commit()
